...
export function OperatorSettingsPage() {
  ...
  const [showMovementNotice, setShowMovementNotice] = useState(false);
  const saveSettings = (next: OperatorSettings) => {
    setSettings(next);
    setShowMovementNotice(true);
