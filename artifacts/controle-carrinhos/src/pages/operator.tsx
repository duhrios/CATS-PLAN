...
export function OperatorPage() {
  const { reservations, movements, movementSettings, updateMovementStatus, markMovementNotAttended, wifiRooms, wifiPoints, assignMobileAntenna, releaseMobileAntenna } = useCampusData();
